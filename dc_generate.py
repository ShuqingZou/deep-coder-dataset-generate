...
class DCGenerator:
    ...
    def __init__(self, num_programs, num_valid, dataset_dir, min_length, max_length,
                 value_range, num_examples, num_prune, list_max, pickle_name, seed):
    ...
    def generate(self):
        ...
        generate_dataset(self.LINQ,
                    ...
                    simplify=self.simplify, decorator=self.iterator_decorator)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--num-valid", type=int, default=10, help="Number of valid programs.")
    ...
    dcg = DCGenerator._from_cli_args(args)

    print("Created DeepCoder dataset generator.")
    print(repr(dcg))  #debuggerino
